...
type User struct {
	...
	ContributorsEnabled bool `json:"contributors_enabled" bson:"contributors_enabled"`
	...
	DefaultProfile bool `json:"default_profile" bson:"default_profile"`

	// When true, indicates that the user has not uploaded their own avatar and a default egg avatar is used instead.
	DefaultProfileImage bool `json:"default_profile_image" bson:"default_profile_image"`
	...
	FollowRequestSent *bool `json:"follow_request_sent" bson:"follow_request_sent"`
	...
	GeoEnabled bool `json:"geo_enabled" bson:"geo_enabled"`
	...
	IsTranslator bool `json:"is_translator" bson:"is_translator"`
	...
	ProfileBackgroundColor *string `json:"profile_background_color" bson:"profile_background_color"`

	// A HTTP-based URL pointing to the background image the user has uploaded for their profile.
	ProfileBackgroundImageUrl *string `json:"profile_background_image_url" bson:"profile_background_image_url"`

	// A HTTPS-based URL pointing to the background image the user has uploaded for their profile.
	ProfileBackgroundImageUrlHttps *string `json:"profile_background_image_url_https" bson:"profile_background_image_url_https"`

	// When true, indicates that the user's profile_background_image_url should be tiled when displayed.
	ProfileBackgroundTile bool `json:"profile_background_tile" bson:"profile_background_tile"`
	...
	ProfileImageUrlHttps string `json:"profile_image_url_https" bson:"profile_image_url_https"`

	// The hexadecimal color the user has chosen to display links with in their Twitter UI.
	ProfileLinkColor string `json:"profile_link_color" bson:"profile_link_color"`

	// The hexadecimal color the user has chosen to display sidebar borders with in their Twitter UI.
	ProfileSidebarBorderColor string `json:"profile_sidebar_border_color" bson:"profile_sidebar_border_color"`

	// The hexadecimal color the user has chosen to display sidebar backgrounds with in their Twitter UI.
	ProfileSidebarFillColor string `json:"profile_sidebar_fill_color" bson:"profile_sidebar_fill_color"`

	// The hexadecimal color the user has chosen to display text with in their Twitter UI.
	ProfileTextColor string `json:"profile_text_color" bson:"profile_text_color"`

	// When true, indicates the user wants their uploaded background image to be used.
	ProfileUseBackgroundImage bool `json:"profile_use_background_image" bson:"profile_use_background_image"`
	...
	ShowAllInlineMedia bool `json:"show_all_inline_media" bson:"show_all_inline_media"`
	...
	WithheldInCountries string `json:"withheld_in_countries" bson:"withheld_in_countries"`
	...
	WithheldScope string `json:"withheld_scope" bson:"withheld_scope"`
}
