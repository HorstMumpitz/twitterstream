...
type Medium struct {
	...
	SecureMediaUrl string    `json:"media_url_https" bson:"media_url_https"`
	Url            string    `json:"url"`
...
type Entities struct {
	...
	Mentions []Mention `json:"user_mentions" bson:"user_mentions"`
	Urls     []Url     `json:"urls"`
}

type Contributor struct {
	Id         int64  `json:"id"`
	IdString   string `json:"id_str" bson:"id_str"`
	ScreenName string `json:"screen_name" bson:"screen_name"`
}
...
type Tweet struct {
	...
	RetweetedStatus *Tweet `json:"retweeted_status" bson:"retweeted_status"`
